...
toast.success("Thanks for being with us!")
    ...
    return (
        <div className="flex flex-col py-10 my-10  md:flex-row justify-between items-center gap-3 p-4 border-2 w-11/12 lg:w-10/12 mx-auto rounded-3xl bg-primary dark:bg-secondary ">
