...
toast.success("Thanks for being with us!")
    ...
    return (
        <div className="flex flex-col py-10 my-10  md:flex-row justify-between items-center gap-3 p-4 border-2 w-11/12 lg:w-10/12 mx-auto rounded-3xl bg-secondary dark:bg-black">
            ...
            <form className="form-control w-11/12 md:w-1/2 " onSubmit={subscriberHandler}>
                <div className="grid grid-cols-5  gap-4">
                    ...
                    <button className="btn rounded-xl border-none bg-gray-300 dark:bg-secondary " >Subscribe</button>
                    </div>
                    
                </div>
                <label className="label">
                    <p className="label-text-alt text-gray-200">By clicking to the Subscribe button, I agree to the <span className="text-blue-700 dark:text-red-500">Terms and Policy</span> of MedCamps.</p>
                </label>
            </form>
        </div>
    );
