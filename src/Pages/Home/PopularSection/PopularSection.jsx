...
const PopularSection = () => {
    ...
    return (
        <div className="mt-10 w-11/12 mx-auto">
            ...
            <div className="w-80 pb-5 ml-auto"><Link to={'/camps'} className="btn btn-sm text-white text-xl py-1 bg-gradient-to-l  from-secondary to-primary dark:from-green-900 dark:to-green-700 w-full">...See All Camps</Link></div>
        </div>
    );
};
